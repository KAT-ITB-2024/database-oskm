...
export const classes = createTable('classes', {
  ...
  type: classSessionEnum('classSession').notNull(),
});
...
export const wrappedProfiles = createTable(
  'wrappedProfiles',
  {
    ...
    personalityDescription: text('personalityDesc'),
    character: text('character'),
    favTopics: varchar('favTopic')
      .array()
      .default(sql`ARRAY[]::varchar[]`), // Tetap gunakan varchar
